(function () {
    ...
    angular.module('cvMakerApp')
        .component('educationForm', {
            templateUrl: '../templates/components/education/education-form.template.html'
        })
        .controller('EducationFormController', EducationFormController);

    EducationFormController.$inject = ['$scope', 'cvMaker', '$timeout', '$window', '$location'];
