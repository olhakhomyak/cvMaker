(function () {
    ...
    angular.module('cvMakerApp')
        .component('experienceForm', {
            templateUrl: '../templates/components/experience/experience-form.template.html',
            bindings: {
              job:'='
            }
        })
        .controller('ExperienceFormController', ExperienceFormController);

    ExperienceFormController.$inject = ['$scope', 'cvMaker', '$timeout', '$window'];
